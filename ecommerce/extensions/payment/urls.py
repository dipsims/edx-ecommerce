...
from ecommerce.extensions.payment.views import PaymentFailedView, SDNFailure, cybersource, paypal, stripe, paystack
...
PAYSTACK_URLS = [
    url(r'^submit/$', paystack.PaystackSubmitView.as_view(), name='submit'),
]
...
urlpatterns = [
    ...
    url(r'^paystack/', include((PAYSTACK_URLS, 'paystack'))),
]
